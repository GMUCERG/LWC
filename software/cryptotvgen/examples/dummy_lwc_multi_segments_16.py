...
if __name__ == '__main__':
    ...
    args = [
        ...
        '--max_block_per_sgmt', '2',                    # Maximum number of blocks per segment
        ...
        '--dest', 'testvectors/dummy_lwc_multi_segments_16', # destination folder
    ...
    # new key (bool), decryt (bool), AD_LEN, PT_LEN, hash-mode (bool)
